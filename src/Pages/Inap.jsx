        ...
        <>
            ...
            <div className="container mx-auto md:px-20 px-10 py-16 mt-10">
                <div className="text-center mb-12">
                    <h1 className="text-4xl font-bold text-gray-800 mb-4">Rawat Inap</h1>
                    <div className="flex justify-center">
                        <img src="./images/inap.jpeg" className='rounded-md md:w-full md:h-60 object-cover object-center overflow-hidden shadow-md mb-4' />
                    </div>
